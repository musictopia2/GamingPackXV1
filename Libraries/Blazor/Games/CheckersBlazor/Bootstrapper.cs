...
namespace CheckersBlazor
{
    public class Bootstrapper : MultiplayerBasicBootstrapper<CheckersShellViewModel>
    {
        ...
        protected override Task ConfigureAsync()
        {
            ...
            OurContainer.RegisterType <BeginningColorProcessorClass<EnumColorChoice, CheckersPlayerItem, CheckersSaveInfo>>();
            OurContainer.RegisterType<BeginningChooseColorViewModel<EnumColorChoice, CheckersPlayerItem>>();
            OurContainer.RegisterType<BeginningColorModel<EnumColorChoice, CheckersPlayerItem>>();
            ...
            MiscDelegates.GetMiscObjectsToReplace = (() =>
            {
                ...
                {
                    typeof(BeginningColorProcessorClass<EnumColorChoice, CheckersPlayerItem, CheckersSaveInfo>),
                    typeof(BeginningColorModel<EnumColorChoice, CheckersPlayerItem>)
