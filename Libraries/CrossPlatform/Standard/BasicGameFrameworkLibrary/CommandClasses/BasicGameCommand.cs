...
namespace BasicGameFrameworkLibrary.CommandClasses
{
    public class BasicGameCommand : IGameCommand
    {
        ...
        public BasicGameCommand(IBasicEnableProcess model, MethodInfo execute, MethodInfo canExecuteM, Action afterChange, CommandContainer container)
        {
        ...
        public BasicGameCommand(IBasicEnableProcess model, MethodInfo execute, PropertyInfo? canExecute, Action afterChange, CommandContainer container)
        {
            UpdateBlazor = afterChange;
            CommandContainer = container;
            _model = model;
