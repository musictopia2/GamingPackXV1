...
namespace SolitaireCardGamesSimpleCP.ViewModels
{
    public class SolitaireCardGamesSimpleShellViewModel : SinglePlayerShellViewModel
    {
        ...
        public SolitaireCardGamesSimpleShellViewModel(IGamePackageResolver mainContainer, CommandContainer container, IGameInfo GameData, ISaveSinglePlayerClass saves) : base(mainContainer, container, GameData, saves)
        {
        }
