...
namespace BasicMultiplayerTrickCardGamesCP.Data
{
	...
	public class BasicMultiplayerTrickCardGamesVMData : ObservableObject, ITrickCardGamesData<BasicMultiplayerTrickCardGamesCardInformation, EnumSuitList>
	{
		...
		{
			Deck1 = new DeckObservablePile<BasicMultiplayerTrickCardGamesCardInformation>(command);
			Pile1 = new SingleObservablePile<BasicMultiplayerTrickCardGamesCardInformation>(command);
			PlayerHand1 = new HandObservable<BasicMultiplayerTrickCardGamesCardInformation>(command);
