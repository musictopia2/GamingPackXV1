...
using BasicMultiplayerTrickCardGamesCP.Logic;
...
{
    [InstanceGame]
    public class BasicMultiplayerTrickCardGamesMainViewModel : TrickCardGamesVM<BasicMultiplayerTrickCardGamesCardInformation, EnumSuitList>
    {
