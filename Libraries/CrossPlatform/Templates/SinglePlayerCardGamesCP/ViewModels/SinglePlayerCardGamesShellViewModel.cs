...
namespace SinglePlayerCardGamesCP.ViewModels
{
    public class SinglePlayerCardGamesShellViewModel : SinglePlayerShellViewModel
    {
        ...
        public SinglePlayerCardGamesShellViewModel(IGamePackageResolver mainContainer, CommandContainer container, IGameInfo GameData, ISaveSinglePlayerClass saves) : base(mainContainer, container, GameData, saves)
        {
        }
