...
namespace SinglePlayerMiscGamesCP.ViewModels
{
    public class SinglePlayerMiscGamesShellViewModel : SinglePlayerShellViewModel
    {
        ...
        public SinglePlayerMiscGamesShellViewModel(IGamePackageResolver mainContainer, CommandContainer container, IGameInfo GameData, ISaveSinglePlayerClass saves) : base(mainContainer, container, GameData, saves)
        {
        }
