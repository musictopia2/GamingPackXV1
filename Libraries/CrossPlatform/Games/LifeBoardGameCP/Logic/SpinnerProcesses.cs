    ...
    public class SpinnerProcesses : ISpinnerProcesses
    {
        ...
        private async Task ResumeSpinnerCompletedAsync()
        {
            ...
            if (_gameBoard.NumberRolled == 0)
            {
                ...
                {
                    ToastPlatform.ShowInfo("Spin again because it landed between two numbers");
                }
            ...
            {
                ToastPlatform.ShowInfo("Current Player Is Getting The $100,000 for 2 8s, 9s or 10s spinned in a row for a lucky break for being entertainer");
