...
namespace MilkRunCP.Cards
{
    public class MilkRunCardInformation : SimpleDeckObject, IDeckObject, IComparable<MilkRunCardInformation>
    {
        ...
        public override BasicDeckRecordModel GetRecord => new BasicDeckRecordModel(Deck, IsSelected, Drew, IsUnknown, IsEnabled, Visible, $"{MilkCategory} {CardCategory} {Points}");
    }
}