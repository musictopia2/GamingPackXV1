...
namespace CaliforniaJackCP.Logic
{
        ...
        , IStartNewGame
    {
        ...
        private readonly CaliforniaJackGameContainer _gameContainer;
        ...
        protected override async Task ComputerTurnAsync()
        {
            ...
            var moveList = SingleInfo!.MainHandList.Where(card => IsValidMove(card.Deck)).Select(card => card.Deck).ToCustomBasicList();
