...
namespace MastermindCP.ViewModels
{
    ...
    /// </summary>
    [InstanceGame]
    public class GameBoardViewModel : BlazorScreenViewModel, IBlankGameVM
    {
        ...
        internal Task NewGameAsync()
        {
            ...
            //hopefully no problem since we don't have scrolltoguess anymore.  web does not support this.
        ...
        //not sure if i can do static for this or not (?)
        ...
        public GameBoardViewModel(GlobalClass global, IFinishGuess mainGame, CommandContainer commandContainer)
        {
            _global = global;
            _mainGame = mainGame;
