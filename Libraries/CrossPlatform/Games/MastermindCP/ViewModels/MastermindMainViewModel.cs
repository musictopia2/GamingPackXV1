...
{
    [InstanceGame]
    public class MastermindMainViewModel : BlazorConductorViewModel, IBasicEnableProcess, IBlankGameVM, IAggregatorContainer
    {
            ...
            )
        {
            ...
            Color1 = new SimpleEnumPickerVM<EnumColorPossibilities>(commandContainer, colorClass);
