...
namespace FlinchCP.Logic
{
    ...
    public class FlinchComputerAI
    {
        ...
        private CustomBasicList<DiscardPileInfo>? _tempDiscardList;
        private DeckRegularDict<FlinchCardInformation>? _tempHand;
        private CustomBasicList<ComputerData>? _startList;
        public int MaxPiles { get; set; }
        public CustomBasicList<ComputerData> ComputerMoves()
        {
        ...
        private ComputerDiscardInfo FindBestStack()
        {
            ...
            int newNums = default;
            CustomBasicList<ComputerDiscardInfo> newList = new CustomBasicList<ComputerDiscardInfo>();
            FlinchCardInformation thisCard;
