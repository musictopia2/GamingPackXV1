...
namespace GrandfathersClockCP.Logic
{
    public class CustomMain : ClockObservable, IMain
    {
        ...
        public CustomMain(ScoreModel thisMod, CommandContainer command, IGamePackageResolver resolver, IEventAggregator aggregator) : base(thisMod, command, resolver, aggregator)
        {
            ShowCenter = false;
            _thisMod = thisMod;
        }
