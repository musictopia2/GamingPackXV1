    ...
    public class ActionEverybodyGetsOneViewModel : BasicActionScreen
    {
        ...
        public async Task GiveCardsAsync()
        {
            ...
            if (ActionContainer.TempHand!.AutoSelect == EnumHandAutoType.SelectOneOnly)
            {
                ...
                {
                    ToastPlatform.ShowError("Must choose a card to give to a player");
                    return;
                }
            ...
            {
                ToastPlatform.ShowError("Cannot choose more than 2 cards to give to player");
                return;
            }
            ...
            {
                ToastPlatform.ShowError($"Cannot choose more than 2 cards each for the player.  So far; you chose {howManySoFar} cards.");
                return;
            }
