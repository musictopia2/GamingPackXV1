...
namespace LifeCardGameCP.Logic
{
    ...
    public class LifeCardGameMainGameClass : CardGameClass<LifeCardGameCardInformation, LifeCardGamePlayerItem, LifeCardGameSaveInfo>, IMiscDataNM
    {
        ...
        protected override Task LastPartOfSetUpBeforeBindingsAsync()
        {
            ...
            {
                throw new BasicBlankException("Must have 6 years passed in the deck.  Rethink");
            }
        ...
        private async Task CheckDeckAsync()
        {
            ...
            do
            {
                ...
                ToastPlatform.ShowInfo($"Time's Flying.  Total years is {SaveRoot.YearsPassed()}.  Therefore; another card is being drawn.");
                if (SaveRoot.YearList.Count == 6)
                {
                    return;
                }
        ...
        {
            ToastPlatform.ShowInfo("Turn back time.  Therefore; the deck is being reshuffled");
