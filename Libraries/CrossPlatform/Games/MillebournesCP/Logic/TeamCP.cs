...
namespace MillebournesCP.Logic
{
    public class TeamCP : ObservableObject
    {
        ...
        {
            CardPiles = new BasicMultiplePilesCP<MillebournesCardInformation>(gameContainer.Command);
            CardPiles.Rows = 1;
            CardPiles.Columns = 3;
        ...
        private CustomBasicList<MillebournesCardInformation> _previouslyPlayed = new CustomBasicList<MillebournesCardInformation>();
        ...
        public void EnableChange()
        {
            ...
            {
                SafetyEnabled = false;
                OnPropertyChanged(nameof(SafetyEnabled));
                return;
            }
