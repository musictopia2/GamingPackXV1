...
namespace DominosMexicanTrainCP.Logic
{
    public class LongestTrainClass
    {
        ...
        public DeckRegularDict<MexicanDomino> GetTrainList(DeckRegularDict<MexicanDomino> piecesCollection, int givenNumber)
        {
            DeckRegularDict<MexicanDomino> output;
            Dictionary<int, MexicanDomino> matchingPieces = new Dictionary<int, MexicanDomino>();
            List<int> Positions = new List<int>();
            DeckRegularDict<MexicanDomino> tempList = new DeckRegularDict<MexicanDomino>();
