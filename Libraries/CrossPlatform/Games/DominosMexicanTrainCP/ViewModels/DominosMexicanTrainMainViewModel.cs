...
namespace DominosMexicanTrainCP.ViewModels
{
    ...
    public class DominosMexicanTrainMainViewModel : DominoGamesVM<MexicanDomino>
    {
        ...
        public HandObservable<MexicanDomino> PlayerHand => _viewModel.PlayerHand1;
        public HandObservable<MexicanDomino> PrivateTrain => _viewModel.PrivateTrain1;
        public DominosBoneYardClass<MexicanDomino> BoneYard => _viewModel.BoneYard;
        public TrainStationBoardProcesses GameBoard => _viewModel.TrainStation1;
        ...
        public void LongestTrain()
        {
            ...
            _viewModel.UpdateCount(_mainGame.SingleInfo); //hopefully this simple this time (?)
        }
    }
}