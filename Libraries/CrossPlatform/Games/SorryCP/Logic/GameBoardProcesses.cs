...
namespace SorryCP.Logic
{
    ...
    public class GameBoardProcesses
    {
        ...
        private async Task ResumeMoveAsync(int howMany, SpaceInfo thisSpace, MoveInfo thisMove)
        {
            ...
            //may not require this anymore since i had some changes to make.  if problems, hopefully would be obvious.
        ...
        private CustomBasicList<PointF> GetComboList(int maxs)
        {
            if (maxs < 2)
            {
                return new CustomBasicList<PointF>(); //needs at least 2.
            }
            CustomBasicList<PointF> output = new CustomBasicList<PointF>();
            int x;
            int y;
            for (x = 1; x <= maxs; x++)
            {
        ...
        private void GetValidSplits(ICustomBasicList<SpaceInfo> thisCol)
        {
            ...
            int newLeft1;
            int newLeft2;
            CustomBasicList<PointF> newCombos = new CustomBasicList<PointF>();
