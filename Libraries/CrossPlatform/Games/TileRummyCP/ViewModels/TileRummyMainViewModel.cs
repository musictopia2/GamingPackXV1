...
namespace TileRummyCP.ViewModels
{
    ...
    public class TileRummyMainViewModel : BasicMultiplayerMainVM
    {
        ...
        public PoolCP GetPool => _model.Pool1;
        public PlayerCollection<TileRummyPlayerItem> GetPlayers => _mainGame.SaveRoot.PlayerList;
        public TempSetsObservable<EnumColorType, EnumColorType, TileInfo> GetTempTiles => _model.TempSets;
        public HandObservable<TileInfo> GetHand => _model.PlayerHand1;
        public MainSets GetMainSets => _model.MainSets1;
